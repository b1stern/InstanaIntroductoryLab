...
In this portion of the lab, you will explore some key Instana capabilities including monitoring of kubernetes, monitoring of 
applications, and monitoring of infrastructure.
...
On the left navigation, select **"Platforms"** and then **"kubernetes"**.  Notice that you have the option of 
selecting other infrastructure providers such as VMware, Power HMC, and zHMC.
...
Once you have found the host, flyover the tower that represents the vader-acemq node.  You need to flyover one of the **corners** of the tower.
...
This is the ACE and MQ server. You can see the MQ and ACE components along 2 discovered JVMs, and processes.
...
In the upper right corner, select the **time selecter** widget and change the time interval to **Last minute**.  
...
Begin by using the breadcumbs at the top of the screen to navigate back to the top level kubernetes cluster view for the vader-qotd2 cluster.
  ![](images/qotd2.png)

Notice that there are log entries at the cluster level.
  ![](images/log.png)

Next, click on the Namespace tab and then select the **qotd** namespace.
  ![](images/qotd-namespace.png)
...
In this exercise you have explored some of the key capabilities within Instana.  You explored kubernetes monitoring. You explored monitoring within the context of kubernetes.  You explored the Infrastructure view.  You defined an 
