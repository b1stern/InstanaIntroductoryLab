...
At the top of the screen, you'll see that there is a dropdown called **Applications -> Calls**.  
If you select the dropdown, you'll notice that there are several options available to analyze Application 
**Calls**, **Traces**, **Websites**, **Mobile Apps**, **Infrastructure** metrics, and **Profiles**.  
For this lab, we'll focus on the default selection of **Application Calls**.  In your spare time, 
feel free to Analyze other types of data.
...
A drop down list will open with a list of the types of calls.  In the seach bar, type **"statement"** 
