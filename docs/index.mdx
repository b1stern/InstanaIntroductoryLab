...
Launch your browser and login to one of the two Instana servers listed above.   You can you a number of different browsers (chrome, firefox, Internet Explorer, or Edge).
