...
You will also notice that there is an **Events** tab and a **Change** tab.  The **Events** tab is all of the raw events 
that are effecting the environnmet.  The **Change** tab is a list of changes that have occurred.  
The **Incidents** are the raw Events that have been correlated via Analytics into an Incident. 
...
In this case, you should see that 4 Events were correlated into a single Incident.  In many cases, you'll see 10 or more.
...
Scroll to the bottom of the page where you see the **call stack**.  Expand the plus signs to see the full **call stack**
