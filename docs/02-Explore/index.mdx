...
On the left navigation, select **"Platforms"** and then **"kubernetes"**.  Notice that you 
have the option of selecting other infrastructure providers such as VMware, Power HMC, and zHMC
